 ...
 * @date : 2010-3-10
 */
@Entity(table = "OAUSERFILEBAK", keys = "bakId")
public class UserFileBak
{
    @Inject
    ...
    @CommonFileColumn(pathColumn = "filePath", target = "{target}", defaultTarget = "userfile",
            path = "userfile/{yyyyMM}/bak/{fileId}/{bakId}")
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof UserFileBak))
            return false;

        UserFileBak userFileBak = (UserFileBak) o;

        return fileId.equals(userFileBak.fileId);
