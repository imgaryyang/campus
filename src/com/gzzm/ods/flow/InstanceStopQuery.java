...
public class InstanceStopQuery extends BaseQueryCrud<OdFlowInstanceStop, Long>
{
    @AuthDeptIds
    @NotSerialized
    ...
    @Lower(column = "stopTime")
    private Date time_start;

    @Upper(column = "stopTime")
    ...
    public InstanceStopQuery()
    {
        addOrderBy("stopTime", OrderType.desc);
    }
    ...
    protected Object createListView() throws Exception
    {
        ...
        view.addComponent("终止时间", "time_start", "time_end");
        ...
        view.addColumn("终止时间", "stopTime").setWidth("125");
        view.addColumn("终止人", "user.userName").setWidth("90");
