 ...
 */
@Service
public abstract class DeptOwnedSubCrud<E, K> extends BaseNormalCrud<E, K> implements DeptOwnedEntityBaseCrud<E, K>
{
    @Inject
    ...
    {
        return new String[]{getOwnerKeyField()};
    }
    ...
    public void initEntity(E entity) throws Exception
    {
        ...
        if (getOwnerKey(entity) == null)
        {
            Object ownerKey = getOwnerKey();
            setOwnerKey(entity, ownerKey);
        }
    }
    ...
    public boolean beforeInsert() throws Exception
    {
        ...
        Object ownerKey = getOwnerKey(getEntity());
        if (ownerKey == null)
        {
            ownerKey = getOwnerKey();

            if (ownerKey != null && !Null.isNull(ownerKey))
                setOwnerKey(getEntity(), ownerKey);
            else
                throw new SystemException(getTopOwnerField() + " cannot be null");
        }

        checkOwnerKey(ownerKey);
