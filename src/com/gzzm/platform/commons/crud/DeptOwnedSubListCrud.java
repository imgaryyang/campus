...
/**
 * 给DeptOwnedSubCrud增加sublist的功能
 *
 * @author camel
 * @date 13-11-13
 */
@Service
public abstract class DeptOwnedSubListCrud<E, K> extends SubListCrud<E, K> implements DeptOwnedEntityBaseCrud<E, K>
{
    @Inject
