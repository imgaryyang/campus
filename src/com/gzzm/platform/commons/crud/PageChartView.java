...
import net.cyan.crud.view.chart.ChartView;
 ...
 * @date 2011-5-27
 */
public class PageChartView extends ChartView implements PageView
{
    /**
     * 页面前的内容
     */
    ...
    public PageChartView addTop(String s)
    {
        if (top == null)
    ...
    @SuppressWarnings("unchecked")
    public PageChartView setDocType(String docType)
    {
    ...
    public PageChartView setDocType()
    {
        return setDocType("<!DOCTYPE>");
    }

    @SuppressWarnings("unchecked")
    private PageChartView writeToHeader(String s)
    {
        if (header == null)
    ...
    @SuppressWarnings("unchecked")
    private PageChartView writeToBottom(String s)
    {
        if (bottom == null)
    ...
    public PageChartView importJs(String path)
    {
    ...
    public PageChartView importCss(String path)
    {
    ...
    public PageChartView importLanguage(String path)
    {
    ...
    public PageChartView run(String script)
    {
        writeToBottom("<script>\n$.onload(function()\n{\n");
        writeToBottom(script);
        return writeToBottom("\n});\n</script>\n");
    ...
    public PageChartView setPageTitle(String pageTitle)
    {
    ...
    public PageChartView setRemark(String remark)
    {
        this.remark = remark;
        return this;
    }
    ...
    {
        addButton(Buttons.getButton("", "left()", "left"));
    }

    public void addRightButton()
    {
        addButton(Buttons.getButton("", "right()", "right"));
    }
}
