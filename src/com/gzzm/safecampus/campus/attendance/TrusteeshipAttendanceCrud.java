...
import com.gzzm.safecampus.campus.trusteeship.TrusteeshipRoomListDisplay;
 ...
 * @date 2018/03/15
 */
@Service(url = "/campus/attendance/truattend")
public class TrusteeshipAttendanceCrud extends StudentOwnedCrud<Attendance, Integer>
{
    ...
    public TrusteeshipAttendanceCrud() {
    ...
    protected Object createListView() throws Exception {
        ComplexTableView view = new ComplexTableView(new TrusteeshipRoomListDisplay(), "relationId");
