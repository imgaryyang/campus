...
import com.gzzm.safecampus.device.card.entity.AreaConfig;
 ...
 * @date 2018/3/21
 */
@Service(url = "/device/crud/AreaConfigCrud")
public class AreaConfigCrud extends BaseNormalCrud<AreaConfig, Integer>
{
    public AreaConfigCrud()
    {
    }
