...
public class AreaConfigModel
{
    ...
    public static class ReqModel
    {
        ...
        private List<AreaConfigModel.Record> RecordList;
        ...
        public List<AreaConfigModel.Record> getRecordList()
        {
            return RecordList;
        }

        public void setRecordList(List<AreaConfigModel.Record> recordList)
        {
