 ...
 */
@Service(url = "/sms/mo")
public class SmsMoCrud extends BaseNormalCrud<SmsMo, Long>
{
    @Inject
    ...
    @Lower(column = "receiveTime")
    private Date time_start;

    @Upper(column = "receiveTime")
    ...
    public SmsMoCrud()
    {
        addOrderBy("receiveTime", OrderType.desc);
    }
    ...
    protected Object createListView() throws Exception
    {
        ...
        view.addColumn("用户", "user.userName").setWidth("100");
    ...
    {
        return new ExportParameters("已收短信列表");
    }
}