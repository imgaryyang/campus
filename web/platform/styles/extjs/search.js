    ...
    setTimeout(function () {
        ...
        if (System.desktopGroupId == "desktop") {
            desktop_top.innerHTML =
                "<div class='desktop-search'><input type='text' id='deskcondition' name='deskcondition'>" +
                "<button  type='button' onclick='search()'><img src='/platform/styles/extjs/icons/fdj.png' />搜索</button> " +
                "<span class='config'><a href='#' onclick='System.Desktop.showConfig();" +
                "return false;'>设置桌面</a></span></div> ";
